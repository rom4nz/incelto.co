...
<body>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <a href="cart.php">
                        <button type="button" class="btn btn-primary-outline">
                            <i class="fa-solid fa-cart-shopping fa-lg" style="color: #FF6B2E;"></i>
                        </button>
                    </a>
                    <?php
                    ...
                    <ul id="accordion" class="accordion">
                        <li class="open">
                            <ul class="submenu open" id="myBtnContainer">
                                ...
                                <a class="button-81" href="products.php?category=furniture" onclick="filterSelection('furniture')" id="furniture"><i class="fa-solid fa-couch ico-img mt-3 mb-3 px-3"></i>Furniture</a>
                                <a class="button-81" href="products.php?category=ElecApp" onclick="filterSelection('ElecApp')" id="ElecApp"><i class="fa-solid fa-tv ico-img mt-3 mb-3 px-3"></i>ElectricAppliances</a>
                                <a class="button-81" href="products.php?category=ornaments" onclick="filterSelection('ornaments')" id="ornaments"><i class="fa-solid fa-mountain-sun ico-img mt-3 mb-3 px-3"></i>Ornaments</a>
                                <a class="button-81" href="products.php?category=CerPor" onclick="filterSelection('CerPor')" id="Architects"><i class="fa-solid fa-mug-saucer ico-img mt-3 mb-3 px-3"></i>Porcelain</a>
                                <a class="button-81" href="products.php?category=hardware" onclick="filterSelection('hardware')" id="hardware"><i class="fa-solid fa-hammer ico-img mt-3 mb-3 px-3"></i>Hardware</a>
                                <a class="button-81" href="products.php?category=GardenDeco" onclick="filterSelection('GardenDeco')" id="Architects"><i class="fa-solid fa-house-chimney-window ico-img mt-3 mb-3 px-3"></i>Garden Decors</a>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-9 col-md-11 col-sm-12 align-items-center">
                ...
                <div class="col-lg-12 m-0 p-0">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <?php
                            $query = "SELECT * FROM product_details WHERE productCategory='$category'";
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                ...
                                for ($i = 0; $i < count($products); $i += 2) {
                                    $productItem1 = $products[$i];
                                    $productItem2 = ($i + 1 < count($products)) ? $products[$i + 1] : null;
                            ?>
                                    <!-- Check User_ID replace hidden with text -->
                                    <tr>
                                        <td class="card-container">
                                            <div class="row">
                                                <!-- Product 1 -->
                                                <div class="col-lg-6 mb-4 mid-card">
                                                    <form method="post" action="php/userCart.php">
                                                        <?php
                                                        if (isset($_GET['msgProd1'])) {
                                                            alertMsg($_GET['msgProd1']);
                                                        }
                                                        ?>
                                                        <div class="col-lg-6 mb-4 mid-card">
                                                            <div class="pic-card col col-lg-12">
                                                                <div class="card-body d-flex align-items-center">
                                                                    <input type="hidden" name="category" placeholder="<?= $category ?>" value="<?= $category ?>">
                                                                    <input type="hidden" name="user_id" placeholder="<?= $user_id ?>" value="<?= $user_id ?>">
                                                                    <a href="productInfo.php?productID=<?= $productItem1["productID"]; ?>">
                                                                        <input type="hidden" name="productID" value="<?= $productItem1["productID"]; ?>">
                                                                        <img src="productAdmin/uploads/<?= $productItem1["imgFile_name"]; ?>" class="pro-img img-fluid">
                                                                    </a>
                                                                    <div class="ms-3">
                                                                        <h3 class="card-title">

                                                                            <?= $productItem1["productName"]; ?>
                                                                            <input type="hidden" name="productName" value="<?= $productItem1["productName"]; ?>">
                                                                            <br>
                                                                            Rs.<?= $productItem1["price"]; ?>/=
                                                                            <input type="hidden" name="price" value="<?= $productItem1["price"]; ?>">
                                                                        </h3>
                                                                        <h5 class="card-subtitle mb-2 text-muted"><?= $productItem1["dscriptn"]; ?></h5>
                                                                        <input type="submit" name="addtoCart1" class="card-title btn btn-dark btn-color2" value="Add to Cart">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <!-- Product 2 -->
                                                <?php if ($productItem2 !== null) { ?>
                                                    <div class="col-lg-6 mb-4 mid-card">
                                                        <form method="post" action="php/userCart.php">
                                                            <?php
                                                            if (isset($_GET['msgProd2'])) {
                                                                alertMsg($_GET['msgProd2']);
                                                            }
                                                            ?>
                                                            <div class="pic-card col-md-4 col-lg-12">
                                                                <div class="card-body d-flex align-items-center">
                                                                    <input type="hidden" name="category" placeholder="<?= $category ?>" value="<?= $category ?>">
                                                                    <input type="hidden" name="user_id" placeholder="<?= $user_id ?>" value="<?= $user_id ?>">
                                                                    <a href="productInfo.php?productID=<?= $productItem2["productID"]; ?>">
                                                                        <input type="hidden" name="productID" value="<?= $productItem2["productID"]; ?>">
                                                                        <img src="productAdmin/uploads/<?= $productItem2["imgFile_name"]; ?>" class="pro-img img-fluid">
                                                                    </a>
                                                                    <div class="ms-3">
                                                                        <h3 class="card-title">
                                                                            <?= $productItem2["productName"]; ?><br>
                                                                            <input type="hidden" name="productName" value="<?= $productItem2["productName"]; ?>">
                                                                            Rs.<?= $productItem2["price"]; ?>/=
                                                                            <input type="hidden" name="price" value="<?= $productItem2["price"]; ?>">
                                                                        </h3>
                                                                        <h5 class="card-subtitle mb-2 text-muted"><?= $productItem2["dscriptn"]; ?></h5>
                                                                        <input type="submit" name="addtoCart2" class="card-title btn btn-dark btn-color2" value="Add to Cart">
                                                                    </div>
                                                                <?php } ?>
                                                                </div>
                                                        </form>
    ...
    <script>
        function filterSelection(selectedCategory) {
            ...
            var imageSources = {
                furniture: "images/1.png",
                ElecApp: "images/2.png",
                ornaments: "images/3.png",
                CerPor: "images/4.png",
                hardware: "images/5.png",
                GardenDeco: "images/6.png",
            };
        ...
        if (storedCategory) {
            ...
            filterSelection('furniture');
            filterSelection('ElecApp');
            filterSelection('ornaments');
            filterSelection('CerPor');
            filterSelection('hardware');
            filterSelection('GardenDeco');
        }
    </script>
</body>
